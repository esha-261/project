...
const NavBar = () => {
  return (
    <div>
      <>
  {/* ========== HEADER ========== */}
  <header className="flex flex-wrap  md:justify-start md:flex-nowrap z-50 w-full bg-stone-950 ">
   
    <nav className="relative max-w-[85rem] w-full mx-auto flex items-center justify-between gap-1 py-2 px-4 sm:px-6 lg:px-8">

{/*icons*/}
<div className='flex'>
<svg xmlns="http://www.w3.org/2000/svg" width={35} height={35} viewBox="0 0 30 30" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-book text-white mt-1.5 ml-5">
...
{/* end icon*/}
      ...
      <a
        className="flex pt-1 font-bold text-xl text-white focus:outline-none focus:opacity-80"
        href="#"
        aria-label="LibraryHub"
      >
        <p>Library</p><p className='text-violet-200' >HUB</p>
      </a>
      </div>
      <div className="md:order-3 flex justify-end items-center gap-x-1">
        ...
        <button
          type="button"
          className="hs-collapse-toggle md:hidden relative p-2 flex items-center font-medium text-[12px] rounded-lg border border-gray-200 text-gray-800 bg-gray-100   hover:bg-zinc-800 hover:text-white disabled:pointer-events-none"
        ...
        <button
          type="button"
          className="relative size-9 flex justify-center items-center text-sm font-semibold rounded-lg border border-transparent text-gray-800 bg-gray-100 focus:outline-none  hover:text-white hover:bg-zinc-800   disabled:pointer-events-none"
          aria-haspopup="dialog"
          aria-expanded="false"
      ...
      <div
        id="hs-header-base"
        className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full fixed top-0 start-0 transition-all duration-300 transform h-full max-w-xs w-full z-[60] bg-stone-950 border-e basis-full grow md:order-2 md:static md:block md:h-auto md:max-w-none md:w-auto md:border-e-transparent md:transition-none md:translate-x-0 md:z-40 md:basis-auto md: hidden "
        role="dialog"
        tabIndex={-1}
        aria-label="Sidebar"
          ...
          <div className="py-2 md:py-0 px-2 md:px-0 flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
            ...
            <div className="grow">
              <div className="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                <a
                  className="px-3 flex items-center text-md text-gray-300 hover:bg-stone-900 hover:text-white rounded-full focus:outline-none focus:bg-gray-100"
                  href="#"
                  aria-current="page"
                >
                  <svg
                ...
                <div className="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] [--is-collapse:true] md:[--is-collapse:false] ">
                  <button
                    ...
                    type="button"
                    className="hs-dropdown-toggle w-full px-3 flex items-center text-md text-gray-300 hover:text-white hover:bg-stone-900 rounded-full focus:outline-none focus:bg-gray-100"
                    aria-haspopup="menu"
                    aria-expanded="false"
                    aria-label="Dropdown"
                  >
                ...
                {/* End Dropdown */}
                <a
                  className="px-3 flex items-center text-md text-gray-300 hover:text-white hover:bg-stone-900 rounded-full focus:outline-none focus:bg-gray-100"
                  href="#"
                >
                  <svg
                    className="shrink-0 size-4 me-3 md:me-2 block md:hidden"
                ...
                <a
                  className="px-3 py-1 flex items-center font-bold text-md bg-gradient-to-tl from-blue-500 to-violet-500 bg-white text-white rounded-full  focus:outline-none  hover:animate-pulse"
                  href="#"
                >
  ...
  >
    ...
    <div className="p-4">
      <p className="text-gray-800">
        We got the updated version of next.js.
      </p>
    </div>
  </div>
  {/* End Offcanvas */}
