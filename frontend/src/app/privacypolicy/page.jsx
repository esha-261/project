            ...
            <div className="sm:p-10 my-auto">
                <section className="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg bg-white">
                    <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
                        ...
                        <div className="col-span-4 bg-gray-100 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
                            <h2 className="mb-8 text-2xl font-bold text-blue-800">Contact Us</h2>
                            <ul>
                                {/* Email Info */}
                                <li className="mb-6 flex items-start text-left">
                                    ...
                                    <div>
                                        <a
                                            className="cursor-pointer font-serif text-base md:text-lg text-blue-600 hover:underline"
                                            href="mailto:info@libraryvault.com"
                                        >
                                            info@libraryvault.com
                                        </a>
                                ...
                                <li className="my-6 flex items-center text-left">
                                    ...
                                    <div>
                                        <a
                                            className="cursor-pointer font-serif text-base md:text-lg text-blue-600 hover:underline"
                                            href="https://twitter.com/libraryvault"
                                        >
                                            @libraryvault
                                        </a>
                                ...
                                <li className="my-6 flex items-center text-left">
                                    ...
                                    <div>
                                        <a
                                            className="cursor-pointer font-serif text-base md:text-lg text-blue-600 hover:underline"
                                            href="https://linkedin.com/in/libraryvault"
                                        >
                                            Library Vault
                                        </a>
                        ...
                        <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
                            <h2 className="mb-8 text-2xl font-bold text-blue-800">Get in Touch</h2>
                            <p className="mt-2 mb-4 font-sans text-sm text-gray-600">
                                Have questions or need help? Reach out to us!
                            </p>
                            <form action="">
                                <div className="md:col-gap-4 mb-5 grid md:grid-cols-2">
                                    <input
                                        className="col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-blue-500"
                                        type="text"
                                        placeholder="Name"
                                        name="name"
                                    />
                                ...
                                <textarea
                                    className="mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-blue-500"
                                    id=""
                                    rows={6}
                                    placeholder="Message"
                                    name="message"
